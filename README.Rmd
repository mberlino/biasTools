...
BiasTools is developed to help me (and other people maybe in the futere) to perform publication bias analysis automaticcally

## Installation

You can install the development version of biasTools from [GitHub](https://github.com/) with:
...
## Main function
- `bias.analysis()` – perform Egger-like publication bias analysis across all levels of a selected moderator within a specific realm
